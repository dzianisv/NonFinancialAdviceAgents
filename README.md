...
<text x="155" y="163" text-anchor="middle" fill="#555" font-size="8" font-family="monospace" font-weight="600">analyse-smartmoney-13f</text>
...
<text x="276" y="163" text-anchor="middle" fill="#555" font-size="8" font-family="monospace" font-weight="600">analyse-smartmoney-13d</text>
...
<text x="417" y="163" text-anchor="middle" fill="#555" font-size="7.5" font-family="monospace" font-weight="600">analyse-smartmoney-ptr</text>
...
<text x="698" y="163" text-anchor="middle" fill="#555" font-size="7.5" font-family="monospace" font-weight="600">analyse-smartmoney-polymarket</text>
...
<text x="522" y="286" text-anchor="middle" fill="#555" font-size="7.5" font-family="monospace" font-weight="600">analyse-smartmoney-positioning</text>
...
| Skill | Description |
|---|---|
| `analyse-onchain` | Crypto analyst lens |
| `analyse-systematic-trading` | Systematic/quant trading lens |
| `analyse-technical` | Technical analysis lens |
...
| `analyse-defi` | DeFi on-chain seat (Burniske value-accrual) — DeFiLlama protocol revenue + fee distribution |
...
| `analyse-fundamental` | Equity fundamentals analysis |
