---
name: analyse-smartmoney-darkpool
description: >-
  ...
  analyse-smartmoney family (market-implied tier); pair with GEX from
  analyse-smartmoney-positioning for regime. Educational, not advice; a lens, not
  gospel.
license: MIT
...
This is the **dark-pool / block-print seat** in the `analyse-smartmoney` family — one of several
...
`analyse-smartmoney-positioning` for regime context before forming a view.
...
| "options skew", "dealer gamma", "GEX", "futures positioning", "funding rate" | `analyse-smartmoney-positioning` (or pair with this skill for GEX) |
| "insider buying", "SEC disclosure", "13F holdings", "13D filing" | `analyse-smartmoney-13f` / `analyse-smartmoney-13d` |
| "put/call ratio", "implied move", "VIX", "max pain" | `analyse-smartmoney-positioning` |
| "order flow", "tape", "volume-at-price", "bid-ask imbalance" | `analyse-orderflow` (lit-market counterpart) |
