...
This file is the source-of-truth for every citation used across the `analyst-smartmoney` skill family. All titles below are **verified** — do not add titles from memory. Honesty flags are stated explicitly where evidence quality is weak, contested, or absent.
