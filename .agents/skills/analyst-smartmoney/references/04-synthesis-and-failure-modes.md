...
This reference contains the load-bearing decision logic for synthesizing across all eight spokes into a single ACCUMULATING / DISTRIBUTING / NEUTRAL verdict. Read this before producing any output from `analyst-smartmoney`.
