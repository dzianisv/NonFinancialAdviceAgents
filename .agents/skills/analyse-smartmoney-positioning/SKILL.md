---
name: analyse-smartmoney-positioning
...
- This is the **continuous** complement to `analyse-smartmoney-polymarket` (discrete event bets). Use both:
...
= gauge, reflexivity = theory). Complements `analyse-smartmoney-polymarket` (discrete) with the continuous
