...
- This skill is the **bottom-up valuation discipline** that complements the macro panel and pairs with
  `analyse-fundamental` + `analyse-smartmoney-13f`; it does not replace the backtest/valuation gate.
