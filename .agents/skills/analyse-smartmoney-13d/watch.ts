 ...
 *
 * Storage: JSONL at $THIRTEEND_LEDGER or .cache/analyse-smartmoney-13d/recommended.jsonl
 * Roster:  JSON  at $THIRTEEND_ROSTER or .cache/analyse-smartmoney-13d/roster.json
 *
...
const LEDGER_PATH =
  process.env.THIRTEEND_LEDGER || join(REPO_ROOT, ".cache", "analyse-smartmoney-13d", "recommended.jsonl");
const ROSTER_PATH =
  process.env.THIRTEEND_ROSTER || join(REPO_ROOT, ".cache", "analyse-smartmoney-13d", "roster.json");
