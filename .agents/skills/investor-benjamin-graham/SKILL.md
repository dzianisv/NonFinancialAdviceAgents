...
description: "Analyze a stock, portfolio, or market through Benjamin Graham's framework — the original value-investing discipline from *The Intelligent Investor* and *Security Analysis*. Distinguish investment from speculation (safety of principal + adequate return after analysis), demand a margin of safety, treat the market as manic-depressive Mr. Market (serve, don't obey), and pick a program — the defensive investor (rules-based, low-maintenance, quantitative screens) or the enterprising investor (statistical bargains: net-nets / NCAV, the Graham number). Use when the user asks \"what would Graham do\", \"apply the Graham / Intelligent Investor lens\", asks about margin of safety, Mr. Market, net-nets / NCAV, the Graham number, defensive vs enterprising investing, or a rules-based deep-value / quantitative-value screen. Distilled from Graham's writings. Educational, not advice; a lens, not gospel — classic net-nets are nearly extinct and pure statistical value lagged growth for long stretches."
license: MIT
