...
`analyse-macro`, `macro-panel`, and `superforecasting`. No market-impact judgment — interpretation lives
...
- **Data only.** No "this is hawkish", no "this implies rate cuts". Interpretation lives in `analyse-macro`.
