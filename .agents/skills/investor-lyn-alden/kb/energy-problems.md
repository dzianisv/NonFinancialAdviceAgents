...
Most hydrocarbon (coal, oil, and gas) deposits on Earth are liquid chemical batteries from lifeforms (ancient forests and seas) that collected solar energy over millions of years and concentrated it with pressure and heat that we can tap into.
...
For example, putting solar panels on your roof along with a battery pack makes you more "energy sovereign". If the grid goes out, you can still get some limited power without the need for refueling (other than some sunshine, including partially cloudy sunshine). It might not be the most efficient power, but that self-ownership and decentralization comes with some benefits. This is a metric where solar power comes in strong.
...
–[Chemical & Engineering News, 2022](https://cen.acs.org/environment/recycling/Solar-panels-face-recycling-challenge-photovoltaic-waste/100/i18#)
...
Similarly, [China produces over 80% of the world's solar panels](https://www.iea.org/news/the-world-needs-more-diverse-solar-panel-supply-chains-to-ensure-a-secure-transition-to-net-zero-emissions). They have a tighter lock on the solar market than OPEC has on the oil market. This could be fixed over time, but basically, countries that are better at manufacturing things cheaply and efficiently have an advantage when it comes to producing solar panels.
...
## Climate Impacts and Trade-Offs

One of the developments that limits new hydrocarbon supply is the set of climate concerns and policies around their increased usage.

For example, President Biden made it a campaign promise to end the drilling for hydrocarbons on federal lands, citing climate reasons. While he hasn't completely eliminated it, he did indeed [lease an order of magnitude fewer drilling permits](https://www.wsj.com/articles/federal-oil-leases-slow-to-a-trickle-under-biden-11662230816) than all other modern presidents at this stage of his administration.

This is a complex subject because it involves climate science, but then also involves domestic politics, geopolitics, ethics, economics, engineering, and so forth. I'm not a climate scientist so aside from looking at data they provide, I focus on those other aspects of this, especially economics and engineering realities.

Hydrocarbons are nature's batteries for solar energy. Methane is "CH4" and can exist without life (e.g. such as on the moon Titan) but most deposits of hydrocarbons on Earth that people collect are considered to be from ancient seas and forests. These lifeforms collected energy from over millions of generations, and as they died and decayed, some of that became concentrated into a very energy-dense chemical battery due to millions of years of pressure and heat.

By pulling hydrocarbons out of the ground and burning them, we release the stored-up energy for productive use, as well as a lot of stored-up carbon in the form of carbon dioxide. For some of them, like coal, they also release a lot of mercury and physical particulates, whereas with natural gas it's mainly just the carbon. Burning a pure gas is cleaner than burning a solid that has impurities in it.

The growth of plants sequesters carbon dioxide; it pulls it out of the atmosphere and puts it into soil, or eventually into deeply buried hydrocarbons. The burning of plants and hydrocarbons releases the accumulated carbon. Farming practices that result in soil reduction also release carbon.

Carbon dioxide is a greenhouse gas, meaning it prevents some of Earth's heat from emanating out. As humans tap into hundreds of millions of years of stored-up carbon and release it into the atmosphere, most models say that it will contribute to long-term heating of the world. A lot of carbon has been sequestered, and we are un-sequestering it.

Many country policymakers are therefore now committed to trying to slow and eventually stop the growth of carbon dioxide emissions.

The complexity here is that it's a multi-disciplinary situation. A physician for example will usually suggest the most extreme healing course to get the best medical outcome, whereas the real course in practice must balance medical advice from the physician but then also economic realities, social realities, and so forth. Similarly, a climate scientist will generally recommend the strictest way to limit carbon dioxide, but from an economic or humanitarian perspective that has to be balanced by other variables.

Generally speaking, certain fields of research like nutritional studies, economic studies, and climate studies are really hard to do A/B tests on. What these areas of research have in common is that they involve the analysis of existing systems so complex that people barely scratch the surface of understanding how they work, and they involve feedback mechanisms so that a given pressure on the system gets responded to by some other part of the system in ways that are not always intuitive or understood. Since they make claims about the future state of complex systems, it makes them more model-reliant than proof-possible.

In other words, while it's not really contested that humans are releasing a significant amount of carbon dioxide and that this has a greenhouse effect over the long term, there are contestations about what exactly we should do about it, and who "we" are in this context. How does one get eight billion humans to do a given thing, and at what cost, specifically?

**Easier Example: The Ozone Problem and Solution**

A constructive example of an atmospheric problem and subsequent solution was the ozone shield depletion in the 1980s and 1990s.

By the 1970s and 1980s, scientists began to repeatedly observe that the Earth's ozone shield was depleting. The ozone shield was proposed as catching most of the ultraviolet radiation before it reaches Earth's surface, and therefore minimizing sun damage to lifeforms.

This depletion was linked to various chemicals and sprays that were being used for industrial and consumer purposes. It's an example of how powerful chemistry can be- even tiny concentrations of novel chemicals can cause rather large shifts in Earth's baseline chemistry, kind of like how a tiny pinprick concentration of acute poison can kill you, or the lack of a tiny amount of micronutrient can also kill you. The Earth's atmosphere and ecosystem are ever-changing systems, but humans have a bigger potential to impact it over a short period of time than other lifeforms.

Scientists presented the evidence regarding the ozone shield, and during the 1980s and 1990s virtually all countries around the world began a rapid phase-out of these chemicals, with various bans being enacted. There was no central authority that could enforce a ban on the world, but most organized bodies accepted the problem, signed agreements, and then actually took action.

Some scientists contested the causality or details of the ozone situation, but importantly (and this was critical), the proposed changes were pretty easy to make. Humanity did not have to go through great sacrifice to cease their seeming impact on the ozone shield. For other than a small number of applications, these ozone-depleting chemicals could be replaced with other chemicals or treated differently, and at a cost that is not recognizable to most people.

By the 2000s, the ozone shield stabilized and began gradually healing, with various projections showing that in several decades, it could be back to where it was in the 1980s.

**Harder Example: Carbon Dioxide**

Getting people to reduce their carbon dioxide emissions is a much bigger "ask" than switching out some ozone-depleting chemicals for other chemicals.

Over three quarters of global energy usage is from hydrocarbons. The other energy sources are all mined and constructed with equipment that runs on hydrocarbons, including the <5% of global energy that comes from wind turbines and solar panels.

The global set of electrical grids (a subset of global energy usage) is only about two-thirds based on hydrocarbons. This is because the portable nature of hydrocarbons makes them good for non-grid applications while hydroelectric and nuclear power are relevant at grid scale.

If an energy source were to be presented that is inherently and obviously more affordable and cleaner, people would of course switch to it, in a similar way that we all adopted the smart phone within a decade. But if people are asked or told to use an energy source that is less reliable or more expensive overall, that's much harder to do, and comes at a human cost.

I think a lot of energy analysis is missing some obvious variables when it comes to energy.

*Energy Diversification and Resilience*

One thing that many people don't take into account is the benefit of energy diversification.

Let's start with a diverse house for an example. They have an electrical connection, a natural gas line, a vehicle that runs on gasoline, and a grill out back with some coal or propane. Those are several separate distribution systems for the household's energy consumption. If the electricity goes out, they can still heat the home, can still cook, and can still drive. If the natural gas gets disrupted, they can still heat parts of the home with an electric heater and can still cook on the grill.

Now we can move onto a more concentrated/streamlined setup, where a house or apartment has an electrical connection, electric heating, an electric stove, and an electric vehicle. Everything is now tied to that electrical connection, and it *better be on*. If it goes off, they lose power, can't heat the home, and can't cook. They can only travel as far as their current vehicle charge will get them, and if the outage is widespread, electric chargers in their area will be off too so they can't get very far. Imagine a whole state or country is setup this way and finds itself in this situation. Residential solar panels and storage can mitigate this to some degree but as previously described, storage potential is quite limited.

Along similar lines, not many countries are planning to make their electrical grids capable of handling 2x to 3x more power throughput, even as they aim towards achieving as much electrification of vehicles and consumer energy as possible. Folding significant portions of the other energy distribution systems into the electrical grid would be a huge and lengthy capital expenditure undertaking, globally.

*Geopolitical Competition*

Another thing that many people don't consider is the rivalry between nations. A country that pursues a de-growth plan for the sake of optimizing global carbon dioxide levels (and eschews nuclear energy as well), can expect to be geopolitically and economically dominated or sidelined over time by countries that don't.

That is, unless they utilize new breakthroughs or new energy sources that can produce usable energy with the same or better abundance, affordability, and reliability as hydrocarbons.

Many unfit beliefs inherently become self-limiting; there's a natural feedback loop there. Some people believe that it's wrong to have children for environmental reasons, for example. Those people tend not to have children while others do, and that's a self-limiting factor on how far that idea can spread. Similarly, countries that don't maintain abundant, affordable, and reliable power will generally see their global standing diminish compared to countries that are more ruthless in regards to how they acquire and use energy, which limits the spread of those types of de-growth initiatives.

*Demand Still Exists if Supply is Disrupted*

Some environmental activists propose that if you add frictions to new supply creation, it will reduce demand. In other words, if you halt new hydrocarbon production and pipelines, then the demand side will work itself out.

But that's not how it works in practice.

The New England region of the United States has been an illustrative example of this. Kinder Morgan (KMI) and other companies have proposed various pipelines for the region for years, to bring them more natural gas, but all of this was opposed by environmental groups. This was an example:
...
> –[E&E News, 2016](https://www.eenews.net/articles/kinder-morgan-cancels-widely-opposed-new-england-pipeline-plan/)

The problem, however, is that the region still demands heating and electricity. As a result, the region has to buy more liquified natural gas from overseas, which is more expensive and less environmentally friendly because it's the same product but with more steps involved (it needs to be super-cooled into a liquid, shipped, and carefully expanded back into a gas, rather than just piped over from a couple states away).

In addition, the region ends up burning oil for electricity as a fallback, which is more expensive and dirtier than using natural gas for the same purpose.
...
> –[Bloomberg, 2022](https://www.bloomberg.com/news/articles/2022-02-22/new-england-power-plants-burn-most-oil-since-2011-as-gas-soars)

*Climate Mastery*

In his book, [Fossil Future](https://www.amazon.com/Fossil-Future-Flourishing-Requires-Gas-Not-ebook/dp/B098M3Y7VC/?&_encoding=UTF8&tag=lynalden-20&linkCode=ur2&linkId=83b6b1daf08938b040a44b48d50c3f0f&camp=1789&creative=9325), Alex Epstein referenced data to show that as humans have impacted the climate in various ways, climate-related deaths per capita have decreased, not increased.

**Chart Source: Alex Epstein*
Why is this? It's because this use of hydrocarbons and other dense energy sources allowed humans to build better structures, pump water, clean water, transport food and aid to impacted areas, transport people out of impacted areas, and so forth.
In other words, even as carbon dioxide could contribute to making more extreme weather events, we must also consider that it enhances humanity's ability to survive those extreme weather events, and that so far this has been lopsided in favor of fewer and fewer deaths per capita.
The poorest regions of the world are likely to be the most harmed by climate change according to most models, partly due to location and partly because they utilize less energy to shield themselves and master the climate around them. A given environmentalist might say that the world needs to restrict its energy usage, and especially its hydrocarbon usage, to prevent these impacts. Someone like Epstein would argue the opposite; that people should do everything in their power to enhance the energy usage of these regions so that they have more climate mastery.
Environmentalists may contest some numbers, may argue that in the future this relationship won't persist, and might very well point out other aspects they disagree with Epstein's book on. However, the ability that energy gives people to deal with the climate is a variable that needs to be considered in public discourse.
**Can We Fine-Tune the Climate?**
Evidence over the last 800,000 years has shown pretty decisively that human discovery and usage of hydrocarbons has caused a significant increase in atmospheric carbon dioxide:

*Chart Source: NASA*
This is from ice core analysis and has been corroborated in other ways.
When the scientists go back further than ice cores, things get murkier since less-direct measurement techniques need to be used. If these sorts of longer-run measures are accurate, then we're currently near the lower end of historical atmospheric carbon dioxide levels and temperatures, although we are rising off of that low base at around 420ppm:

*Source: Earth.org*
Climate.gov has a good article on historical temperatures and evidence for those temperatures:

In that article (on Climate.gov, which is run by the US National Oceanic and Atmospheric Administration), they discuss how the fossil record shows that reptiles and warm-temperature forests existed at the poles, since the poles spent much of their time melted and warm even in their current locations. The article concludes:
...
Now we're coming out of an ice age, with our carbon dioxide emissions likely contributing to that. We're un-sequestering carbon that plants originally sequestered. The Earth has previously thrived during long stretches of completely melted poles and warmer average temperatures.
A key problem is that during those warmer periods, sea levels were as much as 300 meters higher than they are now, again according to fossil records and similar evidence. This is from a combination of melted ice at the poles and the fact that warmer water takes up more volume than colder water. Considering that billions of people and tens of trillions of dollars in property are around the coasts of the world, that is a problem for us.
The pushback would basically be that there's no way to coordinate 8 billion people to do so something, especially if there is no better energy solution, or until there is one. Humans are unlikely to be able to fine-tune carbon dioxide, average temperatures, and sea levels throughout our existence on this planet, and to lock them where central planners want them to be. To the extent that sea levels change over time in part from humans releasing previously-sequestered carbon, people would need to move over time (typical structures are built for decades, and some of the biggest ones for centuries), and we'll need to be more mindful of coastal designs.
Outside of some sort of global top-down coordination to restrict peoples' energy usage in a rather dystopian way (hopefully not), the only path I see for the reduction in carbon dioxide emissions within the next several decades is through better alternatives that make people want to switch to them, or by reaching a natural limit on how much hydrocarbons can be pulled out of the ground per year. The world has, after all, been turning to less conventional oil sources over time, which drives up the cost per barrel and gradually reduces the energy return on investment.
I don't view coercion or intentional de-growth strategies as likely to be successful (or ethical) in a global sense. That's not a statement about climate science itself, but rather it's a statement about economics, geopolitics, engineering, and human behavior.
And I think this topic is going to continue to be grappled with during this decade, which will have implications for energy prices and availability.
There are, however, areas of low-hanging fruit that people can go after.
A significant amount of methane is released from landfills, for example, and it's a more potent greenhouse gas than carbon dioxide. It's an uneconomic and unused energy source for the majority of landfills, since there aren't many flexible-enough sources of demand that can make use of it, at that scale in those locations. Using that methane and converting it into carbon dioxide would be a net negative for overall greenhouse emissions and slow this effect down around the margins, and puts wasted fuel to use. One company recently raised capital to go and get this stranded gas and- you guessed it- they're bitcoin miners.
Improving energy efficiency and reducing unnecessary releases of carbon dioxide and methane into the atmosphere, to at least slow down the greenhouse effect, are among the low-hanging fruits that can be improved over time by nations that want to pursue those goals.
To the extent that environmentalists and politicians choose to optimize for greenhouse gas emissions, I think emphasizing direct carbon capture and re-sequestration to slow down existing emissions, along with landfill methane capture, are better uses of resources from an economic perspective than emphasizing actual supply limitations for hydrocarbons.
...
In the years ahead, I expect higher oil prices, and persistent background inflationary pressures, even though there will naturally be disinflationary periods within that inflationary trend.
Until there is a more robust capex cycle in the energy sector, those disinflationary periods will unfortunately be mostly about the deceleration or cessation of economic growth, rather than the good type of disinflationary growth that people want.*Tweet[**Share](https://www.linkedin.com/cws/share?url=https%3A%2F%2Fwww.lynalden.com%2Fenergy-problems%2F)[**Share](https://www.facebook.com/share.php?u=https%3A%2F%2Fwww.lynalden.com%2Fenergy-problems%2F)