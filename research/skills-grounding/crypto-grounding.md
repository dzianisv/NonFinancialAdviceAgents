...
| dip-tranches-strategy | [`.agents/skills/dip-tranches-strategy/SKILL.md`](../../.agents/skills/dip-tranches-strategy/SKILL.md) | exists — but it is an **S&P-500-ETF** skill, not crypto |
...
| (shared trading-discipline backbone) | [`.agents/skills/risk-management`](../../.agents/skills/risk-management/SKILL.md), [`.agents/skills/trend-following`](../../.agents/skills/trend-following/SKILL.md) | exist — generic, equity-flavoured |
...
| P13 | **Trend / absolute-momentum overlay for directional crypto** (own only while above long MA / beating cash). | Trend-following canon (Faber GTAA, Antonacci dual momentum) — repo `.agents/skills/trend-following` | Gate any directional crypto sleeve on a BTC/asset trend filter (200-day / weekly close); de-risk on a trend break. Already referenced in `STRATEGY.md` "Defend"; make it the *entry* condition for alts too (ties to P3b). |
